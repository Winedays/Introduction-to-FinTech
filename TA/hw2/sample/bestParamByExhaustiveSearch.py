...
# 7.2933
def myStrategy_ls(pastData, currPrice, windowSize, alpha, beta):
    import numpy as np
...
def computeReturnRate(priceVec, windowSize, alpha, beta):
	...
	for ic in range(dataCount):
		...
		suggestedAction[ic]=myStrategy_ls(priceVec[0:ic], currentPrice, windowSize, alpha, beta)		# Obtain the suggested action
...
if __name__=='__main__':
	...
	betaMin=0; betaMax=10;				# Range of beta to explore
